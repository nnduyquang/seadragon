...
<div id="btn-NhanThongTinDuAn">
    <div class="tat-goithongtin d-flex align-items-center"><span>Close</span>
    ...
    <div class="nhan-tt-duan-box position-relative text-center">
        ...
        <form action="/action_page.php">
            ...
            <br>
            <textarea class="ttda_input mr-1" name="" id="" cols="30" rows="4" placeholder="Nội dung...." style="width: 90.8%"></textarea>
